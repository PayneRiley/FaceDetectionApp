...
public class MainActivity extends AppCompatActivity {
    ...
    private static List<RecognizeResult> emotionResult;
                ...
                new AsyncTask<InputStream, String, Face[]>() {
                    ...
                    protected Face[] doInBackground(InputStream... params) {
                        try {
                            ...
                            if (result == null) {
                                publishProgress("Face detection finished, nothing detected");
                                return null;
                            }
                            publishProgress(
                                    String.format("Face detection finished. %d face(s) detected.",
                                            result.length));
                            return result;
                        } catch (Exception e) {
